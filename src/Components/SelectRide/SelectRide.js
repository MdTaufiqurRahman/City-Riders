                ...
                <Col>
                    {form ? <div className="pick-ride-card mt-5">
                        <form>
                            ...
                            marginLeft:'20px'
                            }}  type="text" name="pickFrom" placeholder="Pick From" onBlur={handleChange} required/>
                            <br/>
                            ...
                            border:'1px solid gray',
                            marginLeft:'20px'
                            }} type="text" name="pickTo"  placeholder="Pick To" onBlur={handleChange} required/>
                            <br/>
